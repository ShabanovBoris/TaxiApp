...
public class DriverMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    Button settingButton, signOutButton;
    ...
    private void signOutDriver() {
        ...
        String driverUserId = Objects.requireNonNull(FirebaseAuth.getInstance().getCurrentUser()).getUid();
        DatabaseReference database = FirebaseDatabase.getInstance().getReference()
                .child("geoDrivers");

        GeoFire geoFire = new GeoFire(database);
        geoFire.removeLocation(driverUserId);
        Intent intent = new Intent(DriverMapsActivity.this, DriverSignIn.class);
    ...
    private void updateLocationUI() {
        ...
        if (currentLocation != null) {
            ...
            DatabaseReference databaseGeoDrivers = FirebaseDatabase.getInstance().getReference()
                    .child("geoDrivers");
            ...
            GeoFire geoFire = new GeoFire(databaseGeoDrivers);
